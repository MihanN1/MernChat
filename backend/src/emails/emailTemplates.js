  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0f172a; color: #e2e8f0; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #1e293b; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 20px rgba(0,0,0,0.3);">
      ...
      <div style="text-align: center; padding: 20px; background-color: #1e293b; font-size: 12px; color: #94a3b8;">
        <p>© 2025 MernChat. All rights reserved.</p>
        <p>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Security</a>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Contact Support</a>
        </p>
      </div>
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0f172a; color: #e2e8f0; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #1e293b; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 20px rgba(0,0,0,0.3);">
      ...
      <div style="text-align: center; padding: 20px; background-color: #1e293b; font-size: 12px; color: #94a3b8;">
        <p>© 2025 MernChat. All rights reserved.</p>
        <p>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Account Security</a>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Help Center</a>
        </p>
      </div>
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0f172a; color: #e2e8f0; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #1e293b; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 20px rgba(0,0,0,0.3);">
      ...
      <div style="text-align: center; padding: 20px; background-color: #1e293b; font-size: 12px; color: #94a3b8;">
        <p>© 2025 MernChat. All rights reserved.</p>
        <p>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Account Settings</a>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
          <a href="https://github.com/MihanN1/MernChat/blob/master/README.md" style="color: #38bdf8; text-decoration: none; margin: 0 10px;">Contact Support</a>
        </p>
      </div>
